/*
[rewrite_local]
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/.+$) url script-response-body https://raw.githubusercontent.com/pxx917144686/xx/refs/heads/main/xx.js
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/.+$) url script-request-header https://raw.githubusercontent.com/pxx917144686/xx/refs/heads/main/xx.js
...
if (typeof $response == "undefined") {
  ...
  if (body && body.subscriber) {
    ...
    const list = [
      { "app_name": "CareServer", "bundle_id": "com.jump.ShellBoxKit", "product_id": "app.pxx917144686", "entitlements": ["premium", "Full_access_app"], "version": "1.21" },
    ...
    for (let data of list) {
      if (bundle_id == data.bundle_id || bundle_id == data.app_name) {
        ...
        for (let entitlement of entitlements) {
          subscriber.entitlements[(entitlement)] = { ...date, product_identifier: product_id };
        }
        break;
      }
    }
